...
public interface SchoolRepository extends JpaRepository<School, Long> {
    ...
    List<School> findByOrderByNameDesc();
    ...
    List<School> findAllByNameAndFoundationDate(String name, LocalDate foundationDate);

    List<School> findAllByNameAndIsHighSchool(String schoolName, boolean isHighSchool);
}
