...
public interface SchoolService {
    ...
    List<SchoolDTO> getSchoolsSortedByName(String sortDirection);

    Page<SchoolDTO> getSchoolsPagination(Pageable pageable);

    SchoolDTO getSchool(@Min(1) long id);

    School create(@Valid CreateSchoolDTO createSchoolDTO);
