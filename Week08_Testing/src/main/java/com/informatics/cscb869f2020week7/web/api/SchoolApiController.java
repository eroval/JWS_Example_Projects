...
import com.informatics.cscb869f2020week7.web.view.model.CreateSchoolViewModel;
import com.informatics.cscb869f2020week7.web.view.model.SchoolViewModel;
import com.informatics.cscb869f2020week7.web.view.model.UpdateSchoolViewModel;
...
public class SchoolApiController {
    ...
    @RequestMapping("/{id}")
    public SchoolDTO getSchool(@PathVariable("id") @Min(1) int id) {
        return schoolService.getSchool(id);
    }

    @PostMapping
    public School createSchool(@RequestBody @Valid CreateSchoolViewModel school) {
    ...
    public void softDeleteSchool(@PathVariable long id) {
        School school = modelMapper.map(schoolService.getSchool(id), School.class);
        school.setDeleted(1);
